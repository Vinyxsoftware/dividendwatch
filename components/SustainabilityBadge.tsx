...
const config: Record<SustainabilityStatus, { label: string; dot: string; pill: string }> = {
  green:  { label: "Sustainable", dot: "bg-emerald-600 dark:bg-emerald-400", pill: "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950/40 dark:text-emerald-400 dark:border-emerald-800" },
  yellow: { label: "Review",      dot: "bg-amber-500",                      pill: "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-950/40 dark:text-amber-400 dark:border-amber-800" },
  red:    { label: "At Risk",     dot: "bg-red-500",                        pill: "bg-red-50 text-red-600 border-red-200 dark:bg-red-950/40 dark:text-red-400 dark:border-red-800" },
};
